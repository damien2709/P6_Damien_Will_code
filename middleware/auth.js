...
module.exports = (req, res, next) => {
  try {
    ...
    const decodedToken = jwtoken.verify(token, process.env.KEYTOKEN); // on va décoder le token. On utilise la méthode "verify" du package jsonwebtoken qui prend en 1er argument le token et en 2ème la clé secrète paramétrée dans le controller user, dans la fonction "login".  
